					...
					if (index >= 0)
					{
						...
						if (newbie is Player)
						{
							...
							if (saveSelected.data.Selected == "1")
							{
								...
								{
									newbie.x = sharedData.data.PlayerX;
									newbie.y = sharedData.data.PlayerY;
								}
							}
							else if (saveSelected.data.Selected == "2")
							{
								var sharedData2:SharedObject = SharedObject.getLocal("Save_File_2");
								if (sharedData2.data.PlayerX == 0)
								{
									newbie.x = c * _tileWidth;
									newbie.y = r * _tileHeight;
								}
								...
								{
									newbie.x = sharedData2.data.PlayerX;
									newbie.y = sharedData2.data.PlayerY;
								}
							}
							else if (saveSelected.data.Selected == "3")
							{
								var sharedData3:SharedObject = SharedObject.getLocal("Save_File_3");
								if (sharedData3.data.PlayerX == 0)
								{
									newbie.x = c * _tileWidth;
									newbie.y = r * _tileHeight;
								}
								...
								{
									newbie.x = sharedData3.data.PlayerX;
									newbie.y = sharedData3.data.PlayerY;
								}
							}
						}
						else
